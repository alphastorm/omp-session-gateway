...
- Hosted Windows lifecycle qualification: GitHub Actions run 29715302992 on commit `ff3b56370822` passed config/token ACL checks, UTF-16 scheduled-task install/start, active health/status, atomic token rotation, authenticated graceful PID replacement, active reinstall, and process-clean uninstall.
