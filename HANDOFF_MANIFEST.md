...
- build an immutable candidate tag and repeat signed-artifact, upgrade/rollback, reboot/login persistence, and native Linux/Windows/macOS qualification against the current hardened source;
