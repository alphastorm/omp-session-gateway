...
The initial full smoke failed at View/Control, matching the PWA update navigation described in
the [ADR-018 amendment](DECISIONS.md); its fix is on `main` and unreleased, and no clean
first-attempt upgrade is claimed for v0.5.0. Exact scopes are
