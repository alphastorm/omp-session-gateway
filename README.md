...
**[v0.5.0 release target](https://github.com/alphastorm/omp-session-gateway/releases/tag/v0.5.0)**
...
> **[Get started with v0.5.0 once published](#build-and-run)** ·
...
After publication, start with the [v0.5.0 release](https://github.com/alphastorm/omp-session-gateway/releases/tag/v0.5.0),
...
**v0.5.0 is qualified for stable promotion; publication is pending.** Candidate `v0.5.0-prealpha.1` has
...
| Migration/rollback predecessor | `v0.4.2`, mainline; the predecessor installer takes over a running candidate and both rollback selections activate it, preserving configuration and the readiness credential |
